...
import (
	...
	"github.com/circonus-labs/circonus-unified-agent/plugins/inputs/docker"
	"github.com/docker/docker/api/types"
)

func parseContainerStats(c Container, acc cua.Accumulator, tags map[string]string) {
	id := c.ID
	stats := c.Stats
	tm := stats.Read
...
func metastats(id string, c Container, acc cua.Accumulator, tags map[string]string, tm time.Time) {
...
func memstats(id string, stats types.StatsJSON, acc cua.Accumulator, tags map[string]string, tm time.Time) {
...
func cpustats(id string, stats types.StatsJSON, acc cua.Accumulator, tags map[string]string, tm time.Time) {
...
func netstats(id string, stats types.StatsJSON, acc cua.Accumulator, tags map[string]string, tm time.Time) {
...
func blkstats(id string, stats types.StatsJSON, acc cua.Accumulator, tags map[string]string, tm time.Time) {

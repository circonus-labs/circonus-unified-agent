...
func (bond *Bond) gatherBondInterface(bondName string, rawFile string, acc cua.Accumulator) error {
...
func (bond *Bond) gatherBondPart(bondName string, rawFile string, acc cua.Accumulator) error {
...
func (bond *Bond) gatherSlavePart(bondName string, rawFile string, acc cua.Accumulator) error {
	var slave string
	var status int
...
func init() {
	inputs.Add("bond", func() cua.Input {
		return &Bond{}
	})
}

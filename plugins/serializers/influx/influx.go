...
// Serialize writes the cua.Metric to a byte slice.  May produce multiple
...
func (s *Serializer) buildFooter(m cua.Metric) {
	s.footer = s.footer[:0]
...
func (s *Serializer) writeMetric(w io.Writer, m cua.Metric) error {
	var err error

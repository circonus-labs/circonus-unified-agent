...
func collectEndpoints(ctx context.Context, acc cua.Accumulator, ki *KubernetesInventory) {
...
func (ki *KubernetesInventory) gatherEndpoint(e corev1.Endpoints, acc cua.Accumulator) {

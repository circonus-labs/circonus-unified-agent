...
would result in the following Graphite -> agent transformation.
...
The field keyword tells the agent to give the metric that field name.
...
which would result in the following Graphite -> agent transformation.

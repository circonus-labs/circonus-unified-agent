...
func init() {
	inputs.Add("clickhouse", func() cua.Input {
		return &ClickHouse{
			AutoDiscovery: true,
...
func (ch *ClickHouse) commonMetrics(acc cua.Accumulator, conn *connect, metric string) error {
	var result []struct {
...
func (ch *ClickHouse) zookeeper(acc cua.Accumulator, conn *connect) error {
	var zkExists []struct {
...
func (ch *ClickHouse) replicationQueue(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) detachedParts(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) dictionaries(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) mutations(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) disks(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) processes(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) textLog(acc cua.Accumulator, conn *connect) error {
...
func (ch *ClickHouse) tables(acc cua.Accumulator, conn *connect) error {
	var parts []struct {
...
var _ cua.ServiceInput = &ClickHouse{}

...
func (o *Options) applyFunc(bo BaseOpts, fn ProcessorFunc, metric cua.Metric) {
	if bo.Tag != "" {
...
func (o *Options) processMetric(metric cua.Metric) {
	// Stem
...
func (o *Options) Apply(in ...cua.Metric) []cua.Metric {
	for _, m := range in {
		o.processMetric(m)
	}
...
func init() {
	processors.Add("filepath", func() cua.Processor {
		return &Options{}
	})
}

...
// addStatsXMLv3 walks a v3Stats struct and adds the values to the cua.Accumulator.
func (b *Bind) addStatsXMLv3(stats v3Stats, acc cua.Accumulator, hostPort string) {
...
func (b *Bind) readStatsXMLv3(addr *url.URL, acc cua.Accumulator) error {
	var stats v3Stats

...
func (n *NginxPlusAPI) gatherMetrics(addr *url.URL, acc cua.Accumulator) {
...
func addError(acc cua.Accumulator, err error) {
...
func (n *NginxPlusAPI) gatherProcessesMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherConnectionsMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherSslMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherHTTPRequestsMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherHTTPServerZonesMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherHTTPLocationZonesMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherHTTPUpstreamsMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherHTTPCachesMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherStreamServerZonesMetrics(addr *url.URL, acc cua.Accumulator) error {
...
// Added in 5 API version
func (n *NginxPlusAPI) gatherResolverZonesMetrics(addr *url.URL, acc cua.Accumulator) error {
...
func (n *NginxPlusAPI) gatherStreamUpstreamsMetrics(addr *url.URL, acc cua.Accumulator) error {

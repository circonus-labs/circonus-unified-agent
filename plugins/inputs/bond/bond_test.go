...
Bonding Mode: IEEE 802.3ad Dynamic link aggregati/plugins/inputson
Transmit HashPcflxateeraf
MII Status: up
...
func TestGatherBondInterface(t *testing.T) {
	...
	_ = bond.gatherBondInterface("bond802", sampleTest802, &acc)
	...
	_ = bond.gatherBondInterface("bondAB", sampleTestAB, &acc)

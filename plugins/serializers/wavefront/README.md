...
The `wavefront` serializer translates the internal metric format to the [Wavefront Data Format](https://docs.wavefront.com/wavefront_data_format.html).
...
A Wavefront metric is equivalent to a single field value of an internal measurement.

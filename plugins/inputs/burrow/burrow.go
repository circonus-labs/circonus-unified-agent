...
func init() {
	inputs.Add("burrow", func() cua.Input {
		return &burrow{}
	})
}
...
func (b *burrow) gatherServer(src *url.URL, acc cua.Accumulator) error {
	var wg sync.WaitGroup
...
func (b *burrow) gatherTopics(guard chan struct{}, src *url.URL, cluster string, acc cua.Accumulator) {
	var wg sync.WaitGroup
...
func (b *burrow) genTopicMetrics(r *apiResponse, cluster, topic string, acc cua.Accumulator) {
...
func (b *burrow) gatherGroups(guard chan struct{}, src *url.URL, cluster string, acc cua.Accumulator) {
	var wg sync.WaitGroup
...
func (b *burrow) genGroupStatusMetrics(r *apiResponse, cluster, group string, acc cua.Accumulator) {
...
func (b *burrow) genGroupLagMetrics(r *apiResponse, cluster, group string, acc cua.Accumulator) {
	for _, partition := range r.Status.Partitions {

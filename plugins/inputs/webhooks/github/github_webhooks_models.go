...
func (s CommitCommentEvent) NewMetric() cua.Metric {
...
func (s CreateEvent) NewMetric() cua.Metric {
	event := "create"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeleteEvent) NewMetric() cua.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeploymentEvent) NewMetric() cua.Metric {
	event := "deployment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s DeploymentStatusEvent) NewMetric() cua.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s ForkEvent) NewMetric() cua.Metric {
	event := "fork"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s GollumEvent) NewMetric() cua.Metric {
	event := "gollum"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s IssueCommentEvent) NewMetric() cua.Metric {
	event := "issue_comment"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s IssuesEvent) NewMetric() cua.Metric {
	event := "issue"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s MemberEvent) NewMetric() cua.Metric {
	event := "member"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s MembershipEvent) NewMetric() cua.Metric {
	event := "membership"
	t := map[string]string{
		"event":  event,
		"user":   s.Sender.User,
...
func (s PageBuildEvent) NewMetric() cua.Metric {
	event := "page_build"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s PublicEvent) NewMetric() cua.Metric {
	event := "public"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s PullRequestEvent) NewMetric() cua.Metric {
	event := "pull_request"
	t := map[string]string{
		"event":      event,
		"action":     s.Action,
...
func (s PullRequestReviewCommentEvent) NewMetric() cua.Metric {
...
func (s PushEvent) NewMetric() cua.Metric {
	event := "push"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s ReleaseEvent) NewMetric() cua.Metric {
	event := "release"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s RepositoryEvent) NewMetric() cua.Metric {
	event := "repository"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s StatusEvent) NewMetric() cua.Metric {
	event := "status"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s TeamAddEvent) NewMetric() cua.Metric {
	event := "team_add"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,
...
func (s WatchEvent) NewMetric() cua.Metric {
	event := "delete"
	t := map[string]string{
		"event":      event,
		"repository": s.Repository.Repository,

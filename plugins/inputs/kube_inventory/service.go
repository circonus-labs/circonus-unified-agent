...
func collectServices(ctx context.Context, acc cua.Accumulator, ki *KubernetesInventory) {
...
func (ki *KubernetesInventory) gatherService(s corev1.Service, acc cua.Accumulator) {

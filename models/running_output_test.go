...
func TestRunningOutputWriteFailOrder3(t *testing.T) {
	...
	// Verify that they are in order
	expected := []cua.Metric{first5[0], first5[1], first5[2], first5[3], first5[4], next5[0]}
	assert.Equal(t, expected, m.Metrics())
}

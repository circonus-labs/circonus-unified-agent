...
func (e *Elasticsearch) Gather(acc cua.Accumulator) error {
	...
	if e.ClusterStats || len(e.IndicesInclude) > 0 || len(e.IndicesLevel) > 0 {
		...
		for _, serv := range e.Servers {
			go func(s string, acc cua.Accumulator) {
				defer wgC.Done()
				info := serverInfo{}
...
func (e *Elasticsearch) gatherNodeStats(url string, acc cua.Accumulator) error {
	nodeStats := &struct {
		ClusterName string               `json:"cluster_name"`
		Nodes       map[string]*nodeStat `json:"nodes"`
	}{}
...
func (e *Elasticsearch) gatherClusterHealth(url string, acc cua.Accumulator) error {
...
func (e *Elasticsearch) gatherClusterStats(url string, acc cua.Accumulator) error {
...
func (e *Elasticsearch) gatherIndicesStats(url string, acc cua.Accumulator) error {
	indicesStats := &struct {
...
func init() {
	inputs.Add("elasticsearch", func() cua.Input {

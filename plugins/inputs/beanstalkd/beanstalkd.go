...
func (b *Beanstalkd) gatherServerStats(connection *textproto.Conn, acc cua.Accumulator) error {
...
func (b *Beanstalkd) gatherTubeStats(connection *textproto.Conn, tube string, acc cua.Accumulator) error {
...
func init() {
	inputs.Add("beanstalkd", func() cua.Input {
		return &Beanstalkd{}
	})
}

...
func (c *converter) convertTag(metric cua.Metric) {
...
func (c *converter) convertTagKey(metric cua.Metric) {
	var tags map[string]string
	if c.TagKey == "*" {
		tags = metric.Tags()
	} else {
...
func (c *converter) convertField(metric cua.Metric) {
...
func (c *converter) convertFieldKey(metric cua.Metric) {
	var fields map[string]interface{}
	if c.FieldKey == "*" {
		fields = metric.Fields()
	} else {
...
func (c *converter) convertMeasurement(metric cua.Metric) {
...
func (c *converter) convert(metric cua.Metric) {
	if c.Field != "" {
...
func (s *Strings) Apply(in ...cua.Metric) []cua.Metric {
	s.initOnce()
...
func init() {
	processors.Add("strings", func() cua.Processor {
		return &Strings{}
	})
}

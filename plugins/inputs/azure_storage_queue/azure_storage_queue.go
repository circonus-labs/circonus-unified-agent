...
func (a *AzureStorageQueue) GatherQueueMetrics(acc cua.Accumulator, queueItem azqueue.QueueItem, properties *azqueue.QueueGetPropertiesResponse, peekedMessage *azqueue.PeekedMessage) {
...
func init() {
	inputs.Add("azure_storage_queue", func() cua.Input {

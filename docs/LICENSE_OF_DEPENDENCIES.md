...
When distributed in a binary form, Circonus Unified Agent may contain portions of the following works:
...
- github.com/gosnmp/gosnmp [BSD-Style](https://github.com/gosnmp/gosnmp/blob/master/LICENSE)
...
## circonus-unified-agent used and modified code from these projects

- github.com/influxdata/telegraf [MIT License](https://github.com/influxdata/telegraf/blob/v1.16.1/LICENSE)

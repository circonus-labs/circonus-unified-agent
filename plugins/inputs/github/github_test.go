...
func TestSplitRepositoryNameWithWorkingExample(t *testing.T) {
	var validRepositoryNames = []struct {
		...
		{"circonus-labs/circonus-unified-agent", "circonus-labs", "circonus-unified-agent"},
		{"circonus-labs/circonus-kubernetes-agent", "circonus-labs", "circonus-kubernetes-agent"},

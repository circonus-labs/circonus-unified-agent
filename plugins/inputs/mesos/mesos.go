...
func (m *Mesos) Description() string {
	return "Plugin for gathering metrics from N Mesos masters"
}
...
func (m *Mesos) gatherMainMetrics(u *url.URL, role Role, acc cua.Accumulator) error {
...
func init() {
	inputs.Add("mesos", func() cua.Input {
		return &Mesos{}
	})
}

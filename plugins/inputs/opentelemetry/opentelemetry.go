...
func (*OpenTelemetry) Description() string {
	return "A plugin to collect receive data in the otel format"
}

func (o *OpenTelemetry) Gather(ctx context.Context, _ cua.Accumulator) error {
	return nil
}

func (o *OpenTelemetry) Start(ctx context.Context, accumulator cua.Accumulator) error {
...
func init() {
	inputs.Add("opentelemetry", func() cua.Input {
		return &OpenTelemetry{
			ServiceAddress: "0.0.0.0:4317",
			MetricsSchema:  "prometheus-v2",

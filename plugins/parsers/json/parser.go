...
func (p *Parser) parseArray(data []interface{}, timestamp time.Time) ([]cua.Metric, error) {
	results := make([]cua.Metric, 0)
...
func (p *Parser) parseObject(data map[string]interface{}, timestamp time.Time) ([]cua.Metric, error) {

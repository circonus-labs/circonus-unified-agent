...
It can be used to write to a file using the file output, or for sending metrics to a MID Server with Enable REST endpoint activated using the standard HTTP output.
...
In this case, just add the following section to your config file

```toml
[[outputs.file]]
  ## Files to write to, "stdout" is a specially handled file.
  files = ["C:/Circonus/metrics.out"]

...
func TestListMetricDescriptorFilter(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			stackdriver: &Stackdriver{
				Project:                 "test",
				MetricTypePrefixInclude: []string{"cua/cpu/usage"},
				RateLimit:               1,
			},
			descriptor: &metricpb.MetricDescriptor{
				Type:      "cua/cpu/usage",
			...
			calls: []call{
				{
					...
					filter: `metric.type = starts_with("cua/cpu/usage")`,
				}, {
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage"`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND resource.labels.instance_name = "localhost"`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND resource.labels.instance_name = starts_with("localhost")`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND (resource.labels.instance_name = "localhost" OR resource.labels.zone = starts_with("us-"))`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND metric.labels.resource_type = "instance"`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND metric.labels.resource_id = starts_with("abc-")`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND (metric.labels.resource_type = "instance" OR metric.labels.resource_id = starts_with("abc-"))`,
				},
			},
		},
		{
			...
			calls: []call{
				{
					...
					name:   "ListTimeSeries",
					filter: `metric.type = "cua/cpu/usage" AND (resource.labels.instance_name = "localhost" OR resource.labels.zone = starts_with("us-")) AND (metric.labels.resource_type = "instance" OR metric.labels.resource_id = starts_with("abc-"))`,
				},
			},
		},
	}

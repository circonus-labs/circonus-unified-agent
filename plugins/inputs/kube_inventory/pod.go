...
func (ki *KubernetesInventory) gatherPod(p corev1.Pod, acc cua.Accumulator) {
...
func gatherPodContainer(ki *KubernetesInventory, p corev1.Pod, cs corev1.ContainerStatus, c corev1.Container, acc cua.Accumulator) {
	stateCode := 3
	stateReason := ""
	state := "unknown"

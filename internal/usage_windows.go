...
Examples:
  ...
  circonus-unified-agentd.exe --input-filter cpu --output-filter influxdb config
  ...
  circonus-unified-agentd.exe --config circonus-unified-agent.conf --input-filter cpu:mem --output-filter influxdb

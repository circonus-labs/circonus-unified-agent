...
func (p *Converter) Apply(metrics ...cua.Metric) []cua.Metric {
...
func (p *Converter) convertTags(metric cua.Metric) {
...
func (p *Converter) convertFields(metric cua.Metric) {
...
func init() {
	processors.Add("converter", func() cua.Processor {
		return &Converter{}
	})
}

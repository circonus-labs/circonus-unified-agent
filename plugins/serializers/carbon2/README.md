...
The `carbon2` serializer translates the internal metric format to the [Carbon2 format](http://metrics20.org/implementations/).
...
So, if one internal metric has 4 fields, the `carbon2` output will be 4 separate metrics.

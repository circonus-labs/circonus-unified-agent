...
func (fc *FileCount) count(acc cua.Accumulator, basedir string, glob globpath.GlobPath) {
...
func (fc *FileCount) initGlobPaths(acc cua.Accumulator) {
...
func init() {
	inputs.Add("filecount", func() cua.Input {
		return NewFileCount()
	})
}

...
func TestSerialize(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: []byte(`
# HELP cpu_time_idle Circonus Unified Agent collected metric
...
`),
		},
		{
			...
			expected: []byte(`
# HELP http_requests_total Circonus Unified Agent collected metric
...
`),
		},
		{
			...
			expected: []byte(`
# HELP http_request_duration_seconds Circonus Unified Agent collected metric
...
`),
		},
		{
			...
			expected: []byte(`
# HELP rpc_duration_seconds Circonus Unified Agent collected metric
...
`),
		},
		{
			...
			expected: []byte(`
# HELP cpu::xyzzy_time_idle Circonus Unified Agent collected metric
...
`),
		},
		{
			...
			expected: []byte(`
# HELP cpu_time:idle Circonus Unified Agent collected metric

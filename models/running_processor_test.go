...
type MockProcessor struct {
	ApplyF func(in ...cua.Metric) []cua.Metric
}
...
func (p *MockProcessor) Apply(in ...cua.Metric) []cua.Metric {
	return p.ApplyF(in...)
}
...
func (p *MockProcessorToInit) Apply(in ...cua.Metric) []cua.Metric {
	return in
}

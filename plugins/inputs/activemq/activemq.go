...
func (a *ActiveMQ) GatherTopicsMetrics(acc cua.Accumulator, topics Topics) {
...
func (a *ActiveMQ) GatherSubscribersMetrics(acc cua.Accumulator, subscribers Subscribers) {
...
func init() {
	inputs.Add("activemq", func() cua.Input {
		return &ActiveMQ{
			Server:   "localhost",
			Port:     8161,
			Webadmin: "admin",

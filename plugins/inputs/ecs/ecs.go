...
func (ecs *Ecs) accTask(task *Task, tags map[string]string, acc cua.Accumulator) {
...
func (ecs *Ecs) accContainers(task *Task, taskTags map[string]string, acc cua.Accumulator) {

...
var sampleConfig = `
  ...
  ## circonus-unified-agent metrics.
  ##
  ...
  # they will be splitted and reported as proper key:value in circonus-unified-agent
  # tag_delimiter = ":"
`
...
func (c *Consul) GatherHealthCheck(acc cua.Accumulator, checks []*api.HealthCheck) {
...
func init() {
	inputs.Add("consul", func() cua.Input {
		return &Consul{}
	})
}

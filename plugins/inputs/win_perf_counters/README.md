...
whether the Object, Instance and Counter exist on agent startup.
...
Setting the `CountersRefreshInterval` too low (order of seconds) can cause agent to create a high CPU load.

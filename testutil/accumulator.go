...
func newTrackingID() cua.TrackingID {
	id := atomic.AddUint64(&lastID, 1)
	return cua.TrackingID(id)
}
...
func (a *Accumulator) AddFields(
	...
	a.addFields(measurement, tags, fields, cua.Untyped, timestamp...)
}
...
func (a *Accumulator) AddCounter(
	...
	a.addFields(measurement, tags, fields, cua.Counter, timestamp...)
}
...
func (a *Accumulator) AddGauge(
	...
	a.addFields(measurement, tags, fields, cua.Gauge, timestamp...)
}
...
func (a *Accumulator) AddSummary(
	...
	a.addFields(measurement, tags, fields, cua.Summary, timestamp...)
}
...
func (a *Accumulator) Delivered() <-chan cua.DeliveryInfo {
	a.Lock()
	if a.delivered == nil {
		a.delivered = make(chan cua.DeliveryInfo)
	}
	a.Unlock()
	return a.delivered
}
...
func (n *NopAccumulator) WithTracking(maxTracked int) cua.TrackingAccumulator { return nil }

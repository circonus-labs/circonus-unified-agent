...
// func (s *WavefrontSerializer) serialize(buf *buffer, m cua.Metric) {
...
// func (s *WavefrontSerializer) Serialize(m cua.Metric) ([]byte, error) {
// 	s.mu.Lock()
// 	s.scratch.Reset()
...
// func (s *WavefrontSerializer) SerializeBatch(metrics []cua.Metric) ([]byte, error) {
// 	s.mu.Lock()
// 	s.scratch.Reset()

...
// addXMLv2Counter adds a v2Counter array to a cua.Accumulator, with the specified tags
func addXMLv2Counter(acc cua.Accumulator, commonTags map[string]string, stats []v2Counter) {
...
func (b *Bind) readStatsXMLv2(addr *url.URL, acc cua.Accumulator) error {
	var stats v2Root

...
import (
	...
	v1 "github.com/circonus-labs/circonus-unified-agent/plugins/inputs/mysql/v1"
	v2 "github.com/circonus-labs/circonus-unified-agent/plugins/inputs/mysql/v2"
...
func (m *Mysql) gatherServer(serv string, acc cua.Accumulator) error {
...
// MySQL environment.
func (m *Mysql) gatherGlobalVariables(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
func (m *Mysql) gatherSlaveStatuses(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
func (m *Mysql) gatherBinaryLogs(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
func (m *Mysql) gatherGlobalStatuses(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
func (m *Mysql) GatherProcessListStatuses(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
// and its state with its running count
func (m *Mysql) GatherUserStatisticsStatuses(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
func (m *Mysql) gatherInnoDBMetrics(db *sql.DB, serv string, acc cua.Accumulator) error {
	// run query
...
func (m *Mysql) gatherPerfTableLockWaits(db *sql.DB, serv string, acc cua.Accumulator) error {
...
func (m *Mysql) gatherPerfEventsStatements(db *sql.DB, serv string, acc cua.Accumulator) error {
	query := fmt.Sprintf(
		perfEventsStatementsQuery,
...
func (m *Mysql) gatherTableSchema(db *sql.DB, serv string, acc cua.Accumulator) error {
	var dbList []string
	servtag := getDSNTag(serv)
...
func init() {
	inputs.Add("mysql", func() cua.Input {
		return &Mysql{

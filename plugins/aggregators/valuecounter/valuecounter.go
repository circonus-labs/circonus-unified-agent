...
func NewValueCounter() cua.Aggregator {
	vc := &ValueCounter{}
	vc.Reset()
	return vc
}
...
func (vc *ValueCounter) Add(in cua.Metric) {
	id := in.HashID()
...
func (vc *ValueCounter) Push(acc cua.Accumulator) {
...
func init() {
	aggregators.Add("valuecounter", func() cua.Aggregator {

...
func TestParse_SignSecurityLevel(t *testing.T) {
	...
	metrics, err = parser.Parse(bytes)
	require.NoError(t, err)
	require.Equal(t, []cua.Metric{}, metrics)
...
func TestParseLine(t *testing.T) {
	...
	assertEqualMetrics(t, singleMetric.expected, []cua.Metric{metric})
}
...
func assertEqualMetrics(t *testing.T, expected []metricData, received []cua.Metric) {
